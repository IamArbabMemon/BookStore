...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form action ="dsaBookSearcher.php" method="post" class="d-flex" role="search" >
...
$sql = "SELECT * FROM dsabooks WHERE bookName LIKE '%$item%' ";
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()){
        ...
        echo ' <div class="container " style = "margin-top : 2.5rem"><div class="row"> <div class="col"><div class="card" style="width: 18rem; margin-left:512px;"><img class="card-img-top" src= ' . $row["imageLink"] . ' alt="" height="320px" > <div class="card-body"><h5 class="card-title"> ' .$row["bookName"] .'' .'</h5><p class="card-text">Are you interested in learning the Algorithm and Data Structure and looking for some excellent book that will help you skyrocket your Algorithm and data structure expertise</p><a href="e-commerce-business-technology-society.pdf" class="btn btn-primary">Download</a></div> </div> </div>'  ;
